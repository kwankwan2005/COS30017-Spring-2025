...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val books = listOf(
            Book("Gone with the Wind", 4.0F, "https://covers.openlibrary.org/b/id/9999512-L.jpg"),
            Book("The Lord of the Rings", 1.0F, "https://covers.openlibrary.org/b/id/9999512-L.jpg"),
            Book("The Godfather", 5.0F, "https://covers.openlibrary.org/b/id/9999512-L.jpg"),
        )
